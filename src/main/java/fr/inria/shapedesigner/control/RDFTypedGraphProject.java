 ...
 *
 */
public class RDFTypedGraphProject extends CreateValidateProject {
	public static String jsonKey = "RDFType";
	
	private File rdfFile;
	
	public RDFTypedGraphProject(File rdfFile, PROJECT_TYPE type) throws RDFParseException, UnsupportedRDFormatException, IOException {
		super(new GraphStore(),type);
		this.getGraph().loadDataFromFile(rdfFile);
	...
	public Map<String,Object> toJson(){
		...
		result.put(jsonKey, rdfFile.getPath());
		return result;
	}
